>>Для запуска программы запустить main(), создастся БД и заполнится данными из hh.ru. Если БД уже существует, она удалится.

> ## Обязательное условие. 
> Необходимо создать [database.ini](database.ini) со следующим наполнением:
